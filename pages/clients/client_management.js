...
import { ClientManagementModal, IndustryCategoryModal } from "../../components/Common/Modal";
          ...
          <table className="table table-hover">
            <thead>
              <tr className="text-center">
                ...
                <th className='p-4' scope="col">Client Name</th>
                <th className='p-4' scope="col">Client Contact</th>
                <th className='p-4' scope="col">Client Email </th>
                <th className='p-4' scope="col">Associate</th>
