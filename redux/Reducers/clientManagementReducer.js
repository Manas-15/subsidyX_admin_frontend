...
export function client(
    ...
    switch (action.type) {
        ...
        case clientManagementConstants.CREATE_CLIENT_SUCCESS:
            console.log(action);
            return { ...state, isSuccess: true, clients: [...state.clients, action.data.body] };
        case clientManagementConstants.UPDATE_CLIENT_SUCCESS:
            return {
                ...state, isSuccess: true, clients: state.clients.map(c => {
        ...
        case clientManagementConstants.DELETE_CLIENT_SUCCESS:
            return { ...state, isSuccess: true, clients: state.clients.filter(c => c.id !== action.data.id) };
